...
class ArticleModel {
	...
	late List<ArticleModelTags> tags;
	late String title;
	late int type;
	late int userId;
	late int visible;
  ...
  ArticleModel copyWith({bool? adminAdd, String? apkLink, int? audit, String? author, bool? canEdit, int? chapterId, String? chapterName, bool? collect, int? courseId, String? desc, String? descMd, String? envelopePic, bool? fresh, String? host, int? id, bool? isAdminAdd, String? link, String? niceDate, String? niceShareDate, String? origin, String? prefix, String? projectLink, int? publishTime, int? realSuperChapterId, bool? route, int? selfVisible, int? shareDate, String? shareUser, int? superChapterId, String? superChapterName, List<ArticleModelTags>? tags, String? title, int? type, int? userId, int? visible, int? zan}) {
      return ArticleModel()..adminAdd= adminAdd ?? this.adminAdd
...
class ArticleModelTags {
  ...
  factory ArticleModelTags.fromJson(Map<String, dynamic> json) => $ArticleModelTagsFromJson(json);

  Map<String, dynamic> toJson() => $ArticleModelTagsToJson(this);

  ArticleModelTags copyWith({String? name, String? url}) {
      return ArticleModelTags()..name= name ?? this.name
			..url= url ?? this.url;
  }
